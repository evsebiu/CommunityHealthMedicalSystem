...
MedicalStaff createStaff(Long id, MedicalStaff medicalStaff, Department department);
MedicalStaff deleteStaff(Long id);
MedicalStaff updateStaff(Long id, MedicalStaff medicalStaff, Department department);
}
